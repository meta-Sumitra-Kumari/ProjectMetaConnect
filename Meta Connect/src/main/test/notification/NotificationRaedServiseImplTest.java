...
public class NotificationRaedServiseImplTest {
	...
	@Autowired
	private NotificationReadService notificationReadServiceImpl;
	@Before
	public void setUp() {
	...
	public void testAdd() {
		...
		notificationReadServiceImpl.add(user, notification); 
